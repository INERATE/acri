...
def handle_chat_completion(
    ...
    *,
    ...
    Single-turn only: the last message's content is the query. Multi-turn history
    and actual streaming are for when this is wired into a real `acri up` process.
    """
